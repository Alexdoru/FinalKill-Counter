...
public class CommandReport extends CommandBase implements ICommand {
	...
	public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
		...
		return args.length == 1 ? ( FKCounterMod.isInMwGame() && !MwScoreboardData.isitPrepPhase() ? getListOfStringsMatchingLastWord(args, TabCompletionUtil.getOnlinePlayersByName()) : null ) : (args.length > 1 ? getListOfStringsMatchingLastWord(args, cheats) : null);
	}
